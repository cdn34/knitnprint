...
#[openapi(
    ...
    paths(
        ...
        catalog::category_reorder,
        catalog::shipping_package_list,
        catalog::shipping_package_create,
        catalog::shipping_package_update,
        catalog::shipping_package_delete,
        catalog::add_variant,
        ...
        media::admin_order_product_asset,
        inventory::list,
        inventory::movements,
        inventory::adjust,
    ...
    components(schemas(
        ...
        crate::packlink::PacklinkConfigurationStatus,
        ...
        catalog::ShippingPackageProfile,
        catalog::ShippingPackageProfileRequest,
        catalog::ProductMedia,
        catalog::PersonalizationConfig,
        ...
        media::MediaRecord,
        media::PersonalizationMediaRecord,
